...
cmd("date")
# out: Thu Apr 30 10:02:16 AM UTC 2026
lsalf()
# out: total 76
# out: drwxr-xr-x 1 runner runner  448 Apr 30 10:02 ./
...
# out: drwxr-xr-x 1 runner runner  172 Apr 30 10:02 .git/
# out: -rw-r--r-- 1 runner runner 3077 Feb 27  2024 .gitignore
# out: -rw-r--r-- 1 runner runner   59 Apr 30 10:02 goog.py
...
# out: drwxr-xr-x 1 runner runner  482 Apr 30 10:01 old/
