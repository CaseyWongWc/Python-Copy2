...
Jump to level 1
Complete the for loop to read each line from belt_file into text_line using the syntax for ... in ....
...
for text_line """ Your code goes here """:
    # Each line read from the file ends with a newline.
    print(text_line, end="")  # end="" prints each line without adding another newline.
print()
