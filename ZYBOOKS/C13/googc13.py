...
with _:
    ...
    with _:
        print(MyMultError)
        # out: <function __sc_33__.<locals>.MyMultError at 0x7819f9650040>
        print(MyMultError())
        # out: None
        print(FileNotOpen)
...
with bash:
    ...
    # out: 1
    date
    # out: Sun May  3 15:58:26 UTC 2026
...
with bash:
    python3 -c 'print("ok")'
    # out: ok
    python3 -c 'print("ok")' > output.txt
    cat output.txt
    # out: ok
    python3 demo_run1.py > output.txt
    # err: Traceback (most recent call last):
    # err:   File "/workspaces/Python-Copy2/sandbox/files/demo_run1.py", line 2, in <module>
    # err:     h=input()
    # err: EOFError: EOF when reading a line
    # !err: exit code 1
...
lsalf()
# val: total 264
# val: drwxrwxrwx+ 6 codespace codespace 4096 May  3 15:54 ./
# val: drwxrwxrwx+ 5 codespace codespace 4096 May  3 07:15 ../
# val: drwxrwxrwx+ 2 codespace codespace 4096 May  3 04:40 .run_blocks/
# val: -rw-rw-rw-  1 codespace codespace    0 May  3 11:19 1
# val: -rw-rw-rw-  1 codespace codespace    0 May  3 15:58 1.txt
# val: -rw-rw-rw-  1 codespace codespace 1225 May  3 10:40 10.8 LAB.MD
# val: -rw-rw-rw-  1 codespace codespace 1575 May  3 15:58 10.8 Lab.MD
# val: -rw-rw-rw-  1 codespace codespace 1786 May  3 15:58 10.9 LAB.MD
# val: -rw-rw-rw-  1 codespace codespace 9536 May  3 06:03 10_2.MD
# val: -rw-rw-rw-  1 codespace codespace   51 May  3 12:57 123.py
# val: -rw-rw-rw-  1 codespace codespace   64 May  3 11:59 1234.py
# val: -rw-rw-rw-  1 codespace codespace  108 May  3 07:15 CA10_1_2_p1.py
# val: -rw-rw-rw-  1 codespace codespace    4 May  3 07:15 CA10_1_2_p2.py
# val: -rw-rw-rw-  1 codespace codespace  297 May  3 15:58 CA_10_1_2.py
# val: -rw-rw-rw-  1 codespace codespace  485 May  3 15:58 CA_10_2_1.py
# val: -rw-rw-rw-  1 codespace codespace  295 May  3 15:58 CA_10_2_2.py
# val: -rw-rw-rw-  1 codespace codespace  275 May  3 15:58 CA_10_2_2_1.py
# val: -rw-rw-rw-  1 codespace codespace  265 May  3 15:58 CA_10_2_2_2.py
# val: -rw-rw-rw-  1 codespace codespace  265 May  3 15:58 CA_10_2_2_3.py
# val: -rw-rw-rw-  1 codespace codespace  284 May  3 15:58 CA_10_3_1.py
# val: -rw-rw-rw-  1 codespace codespace  285 May  3 15:58 CA_10_3_1_2.py
# val: -rw-rw-rw-  1 codespace codespace  503 May  3 15:58 CA_10_3_2.py
# val: -rw-rw-rw-  1 codespace codespace  440 May  3 15:58 CA_10_4_1.py
# val: -rw-rw-rw-  1 codespace codespace  480 May  3 15:58 CA_10_5_1.py
# val: -rw-rw-rw-  1 codespace codespace  279 May  3 15:58 FIG_10_6_1.py
# val: -rw-rw-rw-  1 codespace codespace  745 May  3 15:58 Figure 10.4.1.py
# val: -rw-rw-rw-  1 codespace codespace  511 May  3 08:40 Figure 10.5.1.py
# val: -rw-rw-rw-  1 codespace codespace  511 May  3 08:42 Figure_10_5_1.py
# val: -rw-rw-rw-  1 codespace codespace  240 May  3 15:58 LAB_10_10.py
# val: -rw-rw-rw-  1 codespace codespace  342 May  3 15:58 LAB_10_11.py
# val: -rw-rw-rw-  1 codespace codespace  952 May  3 15:58 LAB_10_12.py
# val: -rw-rw-rw-  1 codespace codespace  513 May  3 15:58 LAB_10_7.py
# val: -rw-rw-rw-  1 codespace codespace  216 May  3 15:58 LAB_10_8.py
# val: -rw-rw-rw-  1 codespace codespace  394 May  3 15:58 LAB_10_9.py
# val: -rw-rw-rw-  1 codespace codespace  261 May  3 15:58 PA_10_3_1.py
# val: -rw-rw-rw-  1 codespace codespace  285 May  3 15:58 PA_10_3_1.txt
# val: -rw-rw-rw-  1 codespace codespace  391 May  3 15:58 PA_10_4_1.txt
# val: -rw-rw-rw-  1 codespace codespace  422 May  3 15:58 PA_10_5_1.txt
# val: -rw-rw-rw-  1 codespace codespace  148 May  3 15:58 PA_10_5_2.txt
# val: -rw-rw-rw-  1 codespace codespace  264 May  3 15:58 PA_10_6_1.txt
# val: -rw-rw-rw-  1 codespace codespace  927 May  3 15:58 README.MD
# val: drwxrwxrwx+ 2 codespace codespace 4096 May  3 04:03 S10_1/
# val: drwxrwxrwx+ 2 codespace codespace 4096 May  3 01:39 Section 10.1/
# val: drwxrwxrwx+ 2 codespace codespace 4096 May  3 08:40 __pycache__/
# val: -rw-rw-rw-  1 codespace codespace    8 May  3 10:57 abc.py
# val: -rw-rw-rw-  1 codespace codespace   21 May  2 11:36 data1.txt
# val: -rw-rw-rw-  1 codespace codespace   12 May  2 11:36 data2.txt
# val: -rw-rw-rw-  1 codespace codespace   28 May  2 11:36 data3.txt
# val: -rw-rw-rw-  1 codespace codespace   25 May  3 15:58 delete.py
# val: -rw-rw-rw-  1 codespace codespace  103 May  3 15:58 demo_run.py
# val: -rw-rw-rw-  1 codespace codespace   92 May  3 15:58 demo_run1.py
# val: -rw-rw-rw-  1 codespace codespace   52 May  3 15:58 input.txt
# val: -rw-rw-rw-  1 codespace codespace   37 May  3 15:58 input1.txt
# val: -rw-rw-rw-  1 codespace codespace   37 May  3 15:58 input2.txt
# val: -rw-rw-rw-  1 codespace codespace   13 May  3 08:45 invalidfile1.txt
# val: -rw-rw-rw-  1 codespace codespace  227 May  3 15:58 main.py
# val: -rw-rw-rw-  1 codespace codespace  185 May  3 15:58 my.py
# val: -rw-rw-rw-  1 codespace codespace   16 May  3 15:58 mydata.txt
# val: -rw-rw-rw-  1 codespace codespace   10 May  3 15:58 myfile.txt
# val: -rw-rw-rw-  1 codespace codespace  181 May  3 15:58 mypy.py
# val: -rw-rw-rw-  1 codespace codespace   18 May  3 12:33 names.txt
# val: -rw-rw-rw-  1 codespace codespace    0 May  3 15:57 output.txt
# val: -rw-rw-rw-  1 codespace codespace 1178 May  3 00:41 push_replit.sh
# val: -rw-rw-rw-  1 codespace codespace  221 May  3 05:57 py.py
# val: -rw-rw-rw-  1 codespace codespace   39 May  3 15:58 readme.txt
# val: -rw-rw-rw-  1 codespace codespace   12 May  3 15:58 temp.txt
# val: -rw-rw-rw-  1 codespace codespace   11 May  3 15:58 test.py
