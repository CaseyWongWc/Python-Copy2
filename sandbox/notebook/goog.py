...
Jump to level 1
Add an except block to handle an exception and output "Error: The postal ZIP code entered is invalid".

Click here for example 1 (valid input)
Ex: If the input is 73924, then the output is:

Postal ZIP code is 73924
Click here for example 2 (invalid input)
Ex: If the input is P, then the output is:

Error: The postal ZIP code entered is invalid
try:
    postal_ZIP_code = int(input())
    print(f"Postal ZIP code is {postal_ZIP_code}")

# Your code goes here
'''

with Scratch as a:"CA10_1_2_p1.py"
    # in: 73924
    try: 
        postal_ZIP_code = int(input())
    except:
        print("Error: The postal ZIP code entered is invalid")
a.out
# val: ['5']
####################################################
'''challenge activity
...
'''
with Scratch as a:"CA10_1_2_p2.py"
   pass